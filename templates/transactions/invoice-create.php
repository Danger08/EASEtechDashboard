  ...
  <section class="invoice">
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          ...
          <button type="button" class="btn btn-success pull-right" ng-click="addNewInvoice(invoice.date,invoice.due,invoice.selecteduserdata,invoiceitem,paymentmethodlist)" ng-show="creatinginvoice===undefined"><i class="fa fa-credit-card"></i> Create Invoice
          </button>
          <button type="button" class="btn btn-success pull-right disabled" ng-show="creatinginvoice!=undefined"><i class="fa fa-spinner fa-pulse"></i> Creating invoice
          </button>
