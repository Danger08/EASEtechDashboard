        ...
        <div class="col-md-3">
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              ...
              <li><a ui-sref="tasks({taskstatus: 'All'})"><i class="fa fa-tasks"></i>All</a></li>
                <li><a ui-sref="tasks({taskstatus: 'Created'})"><i class="fa fa-tasks"></i>Created</a></li>
                <li><a ui-sref="tasks({taskstatus: 'inProgress'})"><i class="fa fa-tasks"></i>In Progress</a></li>
                <li><a ui-sref="tasks({taskstatus: 'Completed'})"><i class="fa fa-tasks"></i>Completed</a></li>
                <li><a ui-sref="tasks({taskstatus: 'onHold'})"><i class="fa fa-tasks"></i>On Hold</a></li>
                <li><a ui-sref="tasks({taskstatus: 'Cancelled'})"><i class="fa fa-tasks"></i> Cancelled</a></li>
              </ul>
            </div>
            <!-- /.box-body -->
          </div>
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  ...
                  <tr ng-repeat="task in taskdata | orderBy : '-task_id' | filter : SearchTask :strict" class="animate-show">
                    ...
                    <td class="mailbox-name"><a ui-sref="task({taskid: task.task_id})">{{task.task_name}}</a></td>
